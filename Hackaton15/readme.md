...
## LOGRO: Utilizar ExpressJS NodeJS Socket.io Mysql MongoDB. 
...
Crear un sistema de curier persistente que guarde los paquetes, mensajes, ubicacion del paquete hasta su recepcion que se emitan desde los diferentes clientes logueados.
